...
| Wires Rhino geometry ↔ Motus types | Host-agnostic .NET libraries ([NuGet](https://www.nuget.org/profiles/lasaths) pin **1.8.0**) |
...
- .NET 8 SDK
- Motus.NET **1.8.0** pin ([`build/MotusNetPackages.props`](build/MotusNetPackages.props)) on [nuget.org](https://www.nuget.org/packages/Motus.Core/1.8.0). Default Release restores NuGet; `./build.ps1 -UseLocal` remains for Motus.NET tip / CI.
