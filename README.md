...
| Wires Rhino geometry ↔ Motus types | Host-agnostic .NET libraries ([NuGet](https://www.nuget.org/profiles/lasaths) pin **2.0.0**) |
...
| `MotusNetVersion` | Override NuGet pin (default `2.0.0`) |
