...
Examples target the **current Motus.Grasshopper** build (Motus.NET **1.8.0** NuGet pin; `-UseLocal` for tip). If Grasshopper shows **Unrecognized Objects**, the plugin is not loaded — install, then restart Rhino:
